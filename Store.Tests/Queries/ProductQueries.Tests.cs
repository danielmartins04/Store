...
public class ProductQueriesTests {
    ...
    public ProductQueriesTests() {
        ...
        _products.Add(new Product("Produto 01", 20, true));
        _products.Add(new Product("Produto 01", 30, true));
        _products.Add(new Product("Produto 01", 40, false));
        _products.Add(new Product("Produto 01", 50, false));
    }
